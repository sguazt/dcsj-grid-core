...
/**
 * Interface for format exporters.
 *
 * @author <a href="mailto:marco.guazzone@gmail.com">Marco Guazzone</a>
 */
public interface IFormatExporter
{
	void export(IJob job, PrintWriter wr) throws FormatExporterException;

	void export(IBotJob job, PrintWriter wr) throws FormatExporterException;
}
