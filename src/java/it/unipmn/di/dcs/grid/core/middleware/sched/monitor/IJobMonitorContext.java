 ...
 */
public interface IJobMonitorContext
{
	/**
	 * Returns the handle of the monitored job.
	 */
	IJobHandle jobHandle();

	/**
	 * Returns the old execution status of the monitored job.
	 */
	ExecutionStatus oldJobStatus();

	/**
	 * Returns the current execution status of the monitored job.
	 */
	ExecutionStatus curJobStatus();
}
